...
logging.basicConfig(filename=f'/home/marios/projects/RAG-App-DWS/logs/output_hyde_openai_{TIMESTAMP}.log',
                    level=logging.DEBUG)
...
timer.save_to_file(f'/home/marios/projects/RAG-App-DWS/logs/exectime_hyde_openai_{TIMESTAMP}.log')
# Clear memory
clear_memory()
