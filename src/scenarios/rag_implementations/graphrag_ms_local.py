...
local_func = partial(run_local_search,
...
def graphrag_ms_local():
    ...
    evaluator = Evaluator(eval_dir=EVAL_DIR,
                        query_func=local_func,
                        sampling=SAMPLING, # Testing purposes
                        scenario_label="graph_ms_local"
    )
...
graphrag_ms_local()
timer.save_to_file(f'/home/marios/projects/RAG-App-DWS/logs/exectime_graphrag_ms_local_{TIMESTAMP}.log')
