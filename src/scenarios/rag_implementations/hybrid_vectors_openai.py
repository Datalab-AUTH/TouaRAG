...
logging.basicConfig(filename=f'/home/marios/projects/RAG-App-DWS/logs/output_hybvec_openai_{TIMESTAMP}.log', level=logging.DEBUG)
...
def hybvec():
    ...
    evaluator = Evaluator(eval_dir=EVAL_DIR,
                        ...
                        scenario_label="hybridvec_openai"
    )
...
timer.save_to_file(f'/home/marios/projects/RAG-App-DWS/logs/exectime_hybvec_openai_{TIMESTAMP}.log')
# Clear memory
clear_memory()
