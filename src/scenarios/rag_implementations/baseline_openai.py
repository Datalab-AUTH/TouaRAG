...
logging.basicConfig(filename=f'/home/marios/projects/RAG-App-DWS/logs/output_baseline_openai_{TIMESTAMP}.log',
                    level=logging.DEBUG)
...
def baseline():
    ...
    evaluator = Evaluator(eval_dir=EVAL_DIR,
                        ...
                        scenario_label="baseline_openai"
    )
...
timer.save_to_file(f'/home/marios/projects/RAG-App-DWS/logs/exectime_baseline_openai_{TIMESTAMP}.log')
# Clear memory
clear_memory()
